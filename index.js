...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const listRow = document.querySelector("#list_row");
  ...
  fetch("works.json")
    ...
    .then((data) => {
      ...
      data.forEach((item) => {
        ...
        listItem.className = `item_box ${item.category} col-12 col-lg-4 col-md-6`;
        listItem.innerHTML = `
          <div onclick="window.location='${item.url}';" class="col_container">
